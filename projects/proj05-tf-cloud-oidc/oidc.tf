import {
  ...
  id = "arn:aws:iam::272775097675:oidc-provider/app.terraform.io"
}
...
data "aws_iam_policy_document" "terraform_cloud_admin_assume_policy" {
  statement {
    ...
    condition {
      ...
      "organization:santiago-martinez-lab:project:${var.admin_role_project}:workspace:${workspace}:run_phase:*"]
    }
  }
}
